var StripeM = (function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      function u(e) {
        var t = m("now")();
        return { result: e(), duration: m("now")() - t };
      }
      function a() {
        var e =
                ...
                if (e) {
                  ...
                  return n.then(function (e) {
                    var t = h("now")(),
                      ...
                      i = +(r + n).toPrecision(5);
                    return "object" !== _(e)
                      ? { value: e, internalValue: e, calculationTimeMs: i }
                      : {
                          value: e.value,
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      function I() {
        try {
          return E(
            crypto.getRandomValues(new Uint8Array(B("entropyBitsInNonce") / 8))
          )
            .map(function (e) {
      ...
      function g(e) {
        var t = e.totalDuration,
          ...
          h = i.v2,
          v = B("browserFeatures")();
        E && ((v.a = E), delete i.referrer),
          l && ((v.b = l), delete i.url),
          y && ((v.c = y), delete i.title),
          s && ((v.d = s), delete i.muid),
          f && ((v.e = f), delete i.sid);
        ...
        R && (v.w = R),
          (v.a = B("hashUrlWithAuthorityCheck")(
            new (B("PartitionedUrl"))(v.a)
          ).toString()),
          (v.b = B("hashUrlWithAuthorityCheck")(
            new (B("PartitionedUrl"))(v.b)
          ).toString()),
    ...
    !(function (_) {
      ...
      function s(e, t) {
        ...
        for (n = 0; n < e.length; n += 16)
          (r = l),
            ...
            (l = u(
              l,
              (y = c(y, E, h, l, e[n + 15], 22, 1236535329)),
              E,
              h,
              e[n + 1],
              5,
            ...
            (l = a(
              l,
              (y = u(y, E, h, l, e[n + 12], 20, -1926607734)),
              E,
              h,
              e[n + 5],
              4,
            ...
            (l = f(
              l,
              (y = a(y, E, h, l, e[n + 2], 23, -995338651)),
              E,
              h,
              e[n],
              6,
      ...
      function d(e, t) {
        return (function (e, t) {
          ...
          return (
            (r = s(o.concat(y(t)), 512 + 8 * t.length)), l(s(i.concat(r), 640))
          );
        })(h(e), h(t));
      }
      function b(e, t, n) {
              ...
              try {
                ...
                t.postMessage(
                  JSON.stringify({
                    ...
                    payload: { guid: r, muid: _, sid: o },
                  }),
                  "*"
                );
              } catch (n) {
                t.postMessage(
                  JSON.stringify({ originatingScript: "m", payload: e }),
                  "*"
                );
              }
            } catch (e) {}
          ...
          var t =
            ...
            n =
              arguments.length > 2 && void 0 !== arguments[2]
                ...
                : "6";
          return I("beacon")(
            I("safeBtoa")()(encodeURIComponent(JSON.stringify(e))),
            n
          ).then(t);
        },
        l = function (e) {
        ...
        h = function (e) {
          ...
          try {
            try {
              return (
                e.url &&
                  (e.url = I("hashUrlWithAuthorityCheck")(
                    new (I("PartitionedUrl"))(e.url)
                  ).toString()),
      ...
      function s(e, t) {
        try {
          ...
          if (t && ("object" == typeof t || "function" == typeof t)) {
            var n = t.then;
            if (t instanceof a)
              return (e._state = 3), (e._value = t), void y(e);
          ...
          if (n && ("object" == typeof n || "function" == typeof n)) {
            ...
            if ("function" == typeof i)
              return void i.call(
                ...
                function (n) {
                  (r[e] = { status: "rejected", reason: n }), 0 == --_ && t(r);
                }
              );
          }
          (r[e] = { status: "fulfilled", value: n }), 0 == --_ && t(r);
        }
        for (var i = 0; i < r.length; i++) o(i, r[i]);
      });
    };
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      function y(e, t) {
        ...
        if (_)
          return e({ async: !0, value: _, calculationTimeMs: O("now")() - n });
        var o = {};
        ...
        !(function t() {
          for (var n = O("now")(); f < O("fontsToDetect").length; ) {
            ...
            if (
              (o[l] !== y ? (i.push(s), u.push(1)) : u.push(0),
              (f += 1),
              O("now")() - n > 50)
            )
        ...
        var e = function (e) {
          ...
          setTimeout(function () {
            ...
            t.set(v("adblockerStorageKey"), r),
              e({ value: r.toString(), async: !0, calculationTimeMs: i });
          }, 20);
        };
  ...
  function (e, t) {
    ...
    function l() {
      f &&
        u &&
        ((f = !1), u.length ? (a = u.concat(a)) : (s = -1), a.length && y());
    }
    function y() {
      if (!f) {
        var e = c(l);
