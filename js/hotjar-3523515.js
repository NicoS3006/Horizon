window.hjSiteSettings = window.hjSiteSettings || {
  site_id: 3523515,
  rec_value: 7.999999995789153e-9,
...
!(function () {
    ...
    p = {
      ...
      timeIncr: function (e, t) {
        var n,
          ...
          b = m ? m + (v.total || 0) : v.total;
        return (
          u(e, v.tagName, { total: b }),
          c && p.timeEnd(e, { tag: o, total: b, extraTags: g, type: f }),
          b
        );
      },
  ...
  var _,
    ...
    L = !(
      window.CS_CONF ||
      !(
        (null !== (j = window.hjSiteSettings.features) &&
          void 0 !== j &&
          j.includes("cs_lite")) ||
  ...
  if (
    ((window.hjLazyModules = window.hjLazyModules || {
      SURVEY_V2: { js: "survey-v2.a4d4a69b3c434296ce21.js" },
      SURVEY_BOOTSTRAPPER: {
        js: "survey-bootstrapper.5280a8379cf419902f72.js",
      },
      SURVEY_ISOLATED: { js: "survey-isolated.4552302bd7eac650926f.js" },
      HEATMAP_RETAKER: { js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js" },
      SURVEY_INVITATION: { js: "survey-invitation.9a91b66dc1e33840228c.js" },
      NOTIFICATION: { js: "notification.86732657079a99e6ce8a.js" },
      PREACT_INCOMING_FEEDBACK: {
        js: "preact-incoming-feedback.603d80d591deeda20379.js",
      },
      SENTRY: { js: "sentry.58c81e3e25532810f6fd.js" },
      BROWSER_PERF: { js: "browser-perf.8417c6bba72228fa2e29.js" },
      USER_TEST: { js: "user-test.5bcd2402794f4eb0f7ce.js" },
    }),
    F)
  )
    ...
    var z =
        ((C =
          (_ = window.hjSiteSettings).suppress_all ||
          _.suppress_text ||
          (null === (S = _.suppress_all_on_specific_pages) || void 0 === S
            ? void 0
            : S.length)),
        (O = (function (e) {
          var t,
        ...
        (A = O.anonymisationMethod),
        (x = O.replayRecordingMaskedUrlRegex),
        (I = O.replayRecordingMaskedUrlRegexRules),
        {
          CS_CONF_BASE: {
            projectId: _.cs_project_id,
            smbConfig: {
              siteId: _.site_id,
              useCSTC: !0,
              csLiteDomain:
            ...
            voc:
              (null !== (E = _.feedback_widgets) && void 0 !== E && E.length) ||
              (null !== (R = _.polls) && void 0 !== R && R.length)
                ? { enabled: 1, siteId: _.site_id }
                : { enabled: 0 },
            whitelistedAttributes: [],
            anonymizeDigits: !!C || _.anonymize_digits,
            implementations:
              ((N = _),
              (k = m),
              (U =
                "manual" === (B = N.state_change_listen_mode)
                  ? []
                  : [
                      {
              ...
              U && !Array.isArray(U) && "number" == typeof U.length
                ? v(U, U.length)
                : k(U, P)),
            anonymisationMethod: A,
            replayRecordingMaskedUrlRegex: x,
            replayRecordingMaskedUrlRegexRules: I,
          },
          PII_SELECTORS:
            _.suppress_all ||
            (null === (M = _.suppress_all_on_specific_pages) || void 0 === M
              ? void 0
              : M.length)
              ? ["img, video, source"]
              : null,
      ...
      H = z.CS_CONF_BASE,
      V = z.PII_SELECTORS;
    (window.CS_CONF_BASE = H),
      (window._uxa = window._uxa || []),
      V && window._uxa.push(["setPIISelectors", { PIISelectors: V }]);
    var q = window._hjSettings.environment,
      Y = "t.contentsquare.net";
    q &&
      "live" !== q &&
      (window._hjSettings.csid &&
        (window.CS_CONF_BASE.projectId = window._hjSettings.csid),
      (Y = "t-staging.contentsquare.net"));
    var X = document.createElement("script");
    (X.type = "text/javascript"),
      (X.async = !0),
      (X.src = "//".concat(Y, "/uxa/smb/tag.js")),
