  ...
  [89],
  {
    2041: function (t, e) {
          ...
          (s = 4),
          {
            ...
            debug: function (t, e) {
              void 0 === console.debug && (console.debug = console.log),
                1 >= s &&
                  console.debug(
                    "[" + r.getDurationString(new Date() - i, 1e3) + "]",
                    "[" + t + "]",
                    e
                  );
            },
      ...
      (o.prototype = new a(new ArrayBuffer(), 0, a.BIG_ENDIAN)),
        ...
        (o.prototype.logBufferLevel = function (t) {
          var e,
            ...
            o = [],
            h = "";
          for (e = 0, s = 0, n = 0; e < this.buffers.length; e++)
            (i = this.buffers[e]),
              0 === e
                ? (o.push((a = {})),
                  (a.start = i.fileStart),
        ...
        (o.prototype.findPosition = function (t, e, i) {
          ...
          return -1 === a
            ? -1
            : (n = this.buffers[a]).fileStart + n.byteLength >= e
            ? (r.debug(
                "MultiBufferStream",
          ...
          return (
            (this.parseOneDescriptor = function (e) {
              ...
              return (
                ...
                (n = t[s] ? new i[t[s]](h) : new i.Descriptor(h)).parse(e),
                n
              );
            }),
        ...
        d = {
          ...
          createTrackGroupCtor: function (t, e) {
            (d[t + "TrackGroupTypeBox"] = function (e) {
              ...
              (d[t + "TrackGroupTypeBox"].prototype =
                new d.TrackGroupTypeBox()),
      ...
      d.initialize(),
        ...
        (d.parseOneBox = function (t, e, i) {
          ...
          return p < h
            ...
            : (d[l + "Box"]
                ? (s = new d[l + "Box"](p))
                : "uuid" !== l
                ? (r.warn("BoxParser", "Unknown box type: '" + l + "'"),
                  ((s = new d.Box(l, p)).has_unparsed_data = !0))
                : d.UUIDBoxes[a]
                ? (s = new d.UUIDBoxes[a](p))
                : (r.warn("BoxParser", "Unknown uuid type: '" + a + "'"),
                  ((s = new d.Box(l, p)).uuid = a),
                  (s.has_unparsed_data = !0)),
              (s.hdr_size = h),
              (s.start = o),
              s.write === d.Box.prototype.write &&
                "mdat" !== s.type &&
                (r.info(
                  "BoxParser",
                  "'" +
        ...
        d.createSampleEntryCtor(
          d.SAMPLE_ENTRY_TYPE_METADATA,
          "mett",
          function (t) {
            this.parseHeader(t),
              (this.content_encoding = t.readCString()),
        ...
        d.createFullBoxCtor("sgpd", function (t) {
          ...
          for (var e, i = t.readUint32(), s = 0; s < i; s++)
            (e = d[this.grouping_type + "SampleGroupEntry"]
              ? new d[this.grouping_type + "SampleGroupEntry"](
                  this.grouping_type
                )
              ...
              e.write === d.SampleGroupEntry.prototype.write &&
                (r.info(
                  "BoxParser",
          ...
          if (!this.restoreParsePosition || this.restoreParsePosition())
            for (;;) {
              ...
              if (
                ...
                (t = d.parseOneBox(this.stream, !1)).code ===
          ...
          if (this.moov)
            for (
              n.hasMoov = !0,
                ...
                n.modified = new Date(
                  a + 1e3 * this.moov.mvhd.modification_time
                ),
                n.tracks = [],
                n.audioTracks = [],
                n.videoTracks = [],
          ...
          (this.moov.mvhd.next_track_id = e.id + 1),
            i
              ...
              .set(
                "flags",
                d.TKHD_FLAG_ENABLED |
                  d.TKHD_FLAG_IN_MOVIE |
                  d.TKHD_FLAG_IN_PREVIEW
              )
              .set("creation_time", 0)
              .set("modification_time", 0)
              .set("track_id", e.id)
          ...
          if (
            ...
            for (e = 0; e < r.sample_sizes.length; e++) {
              ...
              (B.number = e),
                  ...
                  ? ((_ = 1),
                    ...
                    (m =
                      c + 1 < s.first_chunk.length
                        ...
                        : 1 / 0))
                  : e < y
                  ? ((B.chunk_index = _), (B.chunk_run_index = c))
                  : (_++,
                    (B.chunk_index = _),
                    (g = 0),
                    _ <= m ||
                ...
                (g += B.size),
                e > U && (S++, U < 0 && (U = 0), (U += n.sample_counts[S])),
                e > 0
                  ? ((t.samples[e - 1].duration = n.sample_deltas[S]),
                    (t.samples_duration += t.samples[e - 1].duration),
                    (B.dts = t.samples[e - 1].dts + t.samples[e - 1].duration))
                  : (B.dts = 0),
                a
                  ? (e >= b &&
                      (x++, b < 0 && (b = 0), (b += a.sample_counts[x])),
                    (B.cts = t.samples[e].dts + a.sample_offsets[x]))
                  : (B.cts = B.dts),
                o
                  ? (e == o.sample_numbers[v] - 1
                      ? ((B.is_sync = !0), v++)
                ...
                u
                  ? (B.degradation_priority = u.priority[e])
            ...
            for (; this.lastMoofIndex < this.moofs.length; )
              if (
                ...
                for (t = 0; t < h.trafs.length; t++) {
                  for (
                    p = h.trafs[t],
                      l = this.getTrackById(p.tfhd.track_id),
                      u = this.getTrexById(p.tfhd.track_id),
                      s =
                        p.tfhd.flags & d.TFHD_FLAG_SAMPLE_DESC
                          ? p.tfhd.default_sample_description_index
                          : u
                          ? u.default_sample_description_index
                          : 1,
                      r =
                        p.tfhd.flags & d.TFHD_FLAG_SAMPLE_DUR
                          ? p.tfhd.default_sample_duration
                          : u
                          ? u.default_sample_duration
                          : 0,
                      n =
                        p.tfhd.flags & d.TFHD_FLAG_SAMPLE_SIZE
                          ? p.tfhd.default_sample_size
                          : u
                          ? u.default_sample_size
                          : 0,
                      a =
                        p.tfhd.flags & d.TFHD_FLAG_SAMPLE_FLAGS
                          ? p.tfhd.default_sample_flags
                          : u
                          ? u.default_sample_flags
                          : 0,
                      p.sample_number = 0,
                      p.sbgps.length > 0 &&
                        f.initSampleGroups(
                    ...
                    for (i = 0; i < m.sample_count; i++) {
                      ((c = {}).moof_number = this.lastMoofIndex),
                        ...
                        p.sample_number++,
                        (c.number = l.samples.length),
                        (p.first_sample_index = l.samples.length),
                        l.samples.push(c),
                        (c.track_id = l.tkhd.track_id),
                        (c.timescale = l.mdia.mdhd.timescale),
                        (c.description_index = s - 1),
                        (c.description =
                          l.mdia.minf.stbl.stsd.entries[c.description_index]),
                        (c.size = n),
                        m.flags & d.TRUN_FLAGS_SIZE &&
                          (c.size = m.sample_size[i]),
                        (l.samples_size += c.size),
                        (c.duration = r),
                        m.flags & d.TRUN_FLAGS_DURATION &&
                          (c.duration = m.sample_duration[i]),
                        (l.samples_duration += c.duration),
                        l.first_traf_merged || i > 0
                          ? (c.dts =
                              l.samples[l.samples.length - 2].dts +
                              l.samples[l.samples.length - 2].duration)
                          : (p.tfdt
                              ? (c.dts = p.tfdt.baseMediaDecodeTime)
                              : (c.dts = 0),
                            (l.first_traf_merged = !0)),
                        (c.cts = c.dts),
                        m.flags & d.TRUN_FLAGS_CTS_OFFSET &&
                          (c.cts = c.dts + m.sample_composition_time_offset[i]),
                        (_ = a),
                        m.flags & d.TRUN_FLAGS_FLAGS
                          ? (_ = m.sample_flags[i])
                          : 0 === i &&
                            m.flags & d.TRUN_FLAGS_FIRST_FLAG &&
                            (_ = m.first_sample_flags),
                        (c.is_sync = !((_ >> 16) & 1)),
                        (c.is_leading = (_ >> 26) & 3),
                        (c.depends_on = (_ >> 24) & 3),
                        (c.is_depended_on = (_ >> 22) & 3),
                        (c.has_redundancy = (_ >> 20) & 3),
                        (c.degradation_priority = 65535 & _);
                  ...
                  if (p.subs) {
                    ...
                    for (e = 0; e < p.subs.entries.length; e++)
                      (b += p.subs.entries[e].sample_delta),
                        ((c = l.samples[b - 1]).subsamples =
        ...
        (f.prototype.getItem = function (t) {
          ...
          for (var e, i, s = 0; s < i.extents.length; s++) {
            ...
            if (n.alreadyRead !== n.length) {
              var o = this.stream.findPosition(
                !0,
        ...
        (f.prototype.initializeSegmentation = function () {
          for (
            ...
            (n.mvhd = this.moov.mvhd),
              ...
              (s.buffer = f.writeInitializationSegment(
                this.ftyp,
                n,
